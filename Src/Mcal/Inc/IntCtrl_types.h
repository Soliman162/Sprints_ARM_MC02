...
typedef enum{
    ...
    GROUP_PRIORITY_0_SUBPRIORITY_0,
    ...
    GROUP_PRIORITY_0_SUBPRIORITY_0=0b000,
    GROUP_PRIORITY_1_SUBPRIORITY_0=0b010,
    GROUP_PRIORITY_2_SUBPRIORITY_0=0b100,
    GROUP_PRIORITY_3_SUBPRIORITY_0=0b110,

    GROUP_PRIORITY_0_SUBPRIORITY_1=0b001,
    GROUP_PRIORITY_1_SUBPRIORITY_1=0b011,
    GROUP_PRIORITY_2_SUBPRIORITY_1=0b101,
    GROUP_PRIORITY_3_SUBPRIORITY_1=0b111,

    /*GROUP_PRIORITY_2_SUBPRIORITY_4*/

    GROUP_PRIORITY_0_SUBPRIORITY_0=0b000,
    GROUP_PRIORITY_0_SUBPRIORITY_1=0b001,
    GROUP_PRIORITY_0_SUBPRIORITY_2=0b010,
    GROUP_PRIORITY_0_SUBPRIORITY_3=0b011,

    GROUP_PRIORITY_1_SUBPRIORITY_0=0b000,
    GROUP_PRIORITY_1_SUBPRIORITY_1=0b101,
    GROUP_PRIORITY_1_SUBPRIORITY_2=0b110,
    GROUP_PRIORITY_1_SUBPRIORITY_3=0b111,
    
    /*GROUP_PRIORITY_1_SUBPRIORITY_8*/

    GROUP_PRIORITY_0_SUBPRIORITY_0=0,
    GROUP_PRIORITY_0_SUBPRIORITY_1,
